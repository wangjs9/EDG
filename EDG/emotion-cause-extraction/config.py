...
parser.add_argument("--l2_reg", type=int, default=5e-2, help="l2 regularization")
...
parser.add_argument("--layer_dropout", type=int, default=0.5, help="softmax layer dropout keep prob")
