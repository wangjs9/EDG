...
parser.add_argument("--posembedding_path", type=str, default="utils/embedding_pos.txt")
...
## hop
parser.add_argument("--maxhop", type=int, default=3)
...
emb_file = "C:/Users/csjwang/Documents/.code/glove.6B/glove.6B.{}d.txt".format(str(emb_dim)) if arg.emb_file == "" else arg.emb_file
